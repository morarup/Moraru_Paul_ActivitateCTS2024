...
public class Main {
    public static void main(String[] args) {
        Pacient pacient = new PacientBuilder()
                .setPatRabatabil(true).setMicDejun(true).setPapuciDeCamera(true).setHalatPentruInterior(true)
                .build();
        ...
        builder_v3.Pacient pacient3= pacientBuilder
                .setPatRabatabil(true).setMicDejun(false).setPapuciDeCamera(true).setHalatDeInterior(true)
                .build();
